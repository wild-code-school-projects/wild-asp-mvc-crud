...
namespace ArticleAssignment.Controllers
{
    public class ArticlesController : Controller
    {
        private readonly ArticleAssignmentContext _context;

        public ArticlesController(ArticleAssignmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Article != null ? 
                          ...
                          Problem("Entity set 'ArticleAssignmentContext.Article'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ArticleAssignmentContext.Article'  is null.");
            }
            var article = await _context.Article.FindAsync(id);
            if (article != null)
            {
